...
public class RecycleViewAdapter extends RecyclerViewAdapterHelper<GuanZhu> {
    public interface IOnItemClickListener{
        void onclick(int position);
    }
    private Context context;
    private InRecycleAdapter.IOnItemClickListener itemClickListener;
    public RecycleViewAdapter(Context context, List<GuanZhu> list) {
        super(context, list);
    ...
    public void onBindMyViewHolder(RecyclerView.ViewHolder holder, int position) {
        final GuanZhu guanZhu = mList.get(position);
