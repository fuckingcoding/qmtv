 ...
 * File    Name:AlertRecycleAdapter
 * Created by WYJ on 16/12/1.
 * Description :TODO
 */

public class AlertRecycleAdapter extends RecyclerViewAdapterHelper<Alert>{

    private Context context;


    public AlertRecycleAdapter(Context context, List<Alert> list) {
        super(context, list);
    ...
    public void onBindMyViewHolder(RecyclerView.ViewHolder holder, int position) {
        final Alert guanZhu = mList.get(position);
